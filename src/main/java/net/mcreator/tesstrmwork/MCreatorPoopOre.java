...
public class MCreatorPoopOre extends Elementstesstrmwork.ModElement {
	@ObjectHolder("tesstrmwork:poopore")
	public static final Block block = null;
	public MCreatorPoopOre(Elementstesstrmwork instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorPoopGem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("poopore", "poopore", blockAt -> {
